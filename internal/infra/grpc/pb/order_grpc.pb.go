...
const (
	...
	OrderService_GetList_FullMethodName     = "/pb.OrderService/GetList"
)
...
type OrderServiceClient interface {
	...
	GetList(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*GetOrderListResponse, error)
}
...
func (c *orderServiceClient) GetList(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*GetOrderListResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type OrderServiceServer interface {
	...
	GetList(context.Context, *Empty) (*GetOrderListResponse, error)
...
func (UnimplementedOrderServiceServer) GetList(context.Context, *Empty) (*GetOrderListResponse, error) {
...
func _OrderService_GetList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).GetList(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
